            ...
            <div className="videos">
              <div className="video">
                <VideoCard
                  ...
                  duration={toMin(125)}
                  thumbnail={
                    "https://res.cloudinary.com/desdkbhvz/image/upload/v1705578484/j680f6u20a426xagjlys.png"
                  }
                  profileImage={
                    "https://res.cloudinary.com/desdkbhvz/image/upload/v1705077731/u17mqgolmdz2owhrwzkv.jpg"
                  }
                />
              </div>
              <div className="video">
            ...
            <div className="courses">
              <Card sx={{ width: "100%" }}>
                ...
                <CardContent>
                  ...
                  >
                    {filterDesc(
                      "React.js is an open-source JavaScript library for building user interfaces, known for its declarative syntax, component-based architecture, and efficient updates through a virtual DOM."
                    )}
                  </Typography>
                  <div className="tags">
